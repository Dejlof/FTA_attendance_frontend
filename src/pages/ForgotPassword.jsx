    ...
    <article className='flex h-screen flex-col lg:flex-row text-[#003B65] text-xs lg:text-sm'>
        ...
        <div className='flex flex-col h-screen justify-center items-center lg:w-1/2'>
            ...
            <form className='pt-6 pb-4 gap-2'>
                <label>Email
                    <br></br>
                    <input className='border border-gray-200 bg-gray-100 pl-5 pr-2 w-72 md:w-96 md:pl-5 py-3 mt-1 mb-2 md:py-4 rounded-md font-extralight focus:outline-none focus:bg-white text-[#003B65]' placeholder='Please enter your email' />
                </label>
                <br></br>
            </form>
